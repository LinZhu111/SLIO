...
# from models.spk2imgnet import new_Spike_Net_v3
from models.reconflownet import ReconFlowNet
###############################################################################
# Functions
###############################################################################
...
#     elif generator_name == 'spk2img_net':
#         model_g = new_Spike_Net_v3(12, 64, 6, 5)
    elif generator_name == 'reconflow_net':
        model_g = ReconFlowNet(32, 3)
    else:
